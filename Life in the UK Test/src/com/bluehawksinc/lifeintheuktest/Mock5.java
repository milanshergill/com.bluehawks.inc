...
public class Mock5 extends Activity
{
        ...
        case END:
         ...
         builder.setMessage("Are you sure you want to exit?")
               ...
               .setPositiveButton("Yes", new DialogInterface.OnClickListener() 
               {
                   ...
                   mdb.open();
                   mdb.updateMock5(score);
                   mdb.close();
                   Intent i1 = new Intent(Mock5.this,End4.class);
           startActivity(i1);
...
break;
   default:
    mSoundManager.playSound(2);
    Intent i2 = new Intent(Mock5.this,End4.class);
    startActivity(i2);
   finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
...
int[] numbers = {83,128,13,126,47,169,263,177,167,146,417,482,272,439,386,678,546,505,612,661,733,722,797,799};
...
else
{
  ...
  mdb.updateMock5(0);
      ...
      score=0;
       mdb.close();
  Intent i3 = new Intent(Mock5.this,End4.class);
  startActivity(i3);
 finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
...
/*fuck u jatin have fun with sign.java*/