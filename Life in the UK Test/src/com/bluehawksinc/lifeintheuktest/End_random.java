...
public class End_random extends Activity 
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        setContentView(R.layout.endrandom);
       ...
       mdb.open();
        ...
        findViewById(R.id.home).setOnClickListener(new View.OnClickListener() 
        {
    		public void onClick(View v) 
    		{
    			...
    			Intent i1 = new Intent(End_random.this,Main_Screen.class);
    			startActivity(i1);
    			finish();
    		}
    	});
        ...
        next1.setOnClickListener(new View.OnClickListener() 
        {
			...
			public void onClick(View v)
			{
				mSoundManager.playSound(2);
				//mSoundManager.playSound(1);
				Intent i1 = new Intent(End_random.this,SpecialInfo.class);
				startActivity(i1);
				finish();
			}
		});
        findViewById(R.id.answer).setOnClickListener(new View.OnClickListener() 
        {
    		public void onClick(View v) 
    		{
    			if(Mock_random.incorrect.isEmpty())
    			{
    				AlertDialog.Builder builder = new AlertDialog.Builder(End_random.this);
    			...
    			{
    				mSoundManager.playSound(2);
    				Intent i1 = new Intent(End_random.this,ans_random.class);
    				startActivity(i1);
    				finish();
    			}
    		}
