...
public class Mock13 extends Activity
{
        ...
        case END:
         ...
         builder.setMessage("Are you sure you want to exit?")
               ...
               .setPositiveButton("Yes", new DialogInterface.OnClickListener() 
               {
                   ...
                   mdb.open();
                   mdb.updateMock13(score);
                   mdb.close();
                   Intent i1 = new Intent(Mock13.this,End13.class);
           startActivity(i1);
...
break;
   default:
    mSoundManager.playSound(2);
    Intent i2 = new Intent(Mock13.this,End13.class);
    startActivity(i2);
   finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
...
int[] numbers = {85,119,131,113,182,253,243,233,264,311,484,411,349,300,535,502,491,537,532,780,709,783,748,812};
...
else
{
  ...
  mdb.updateMock13(0);
      ...
      score=0;
       mdb.close();
  Intent i3 = new Intent(Mock13.this,End13.class);
  startActivity(i3);
 finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
