...
public class Mock3 extends Activity
{
        ...
        case END:
         ...
         builder.setMessage("Are you sure you want to exit?")
               ...
               .setPositiveButton("Yes", new DialogInterface.OnClickListener() 
               {
                   ...
                   mdb.open();
                   mdb.updateMock3(score);
                   mdb.close();
                   Intent i1 = new Intent(Mock3.this,End2.class);
           startActivity(i1);
...
break;
   default:
    mSoundManager.playSound(2);
    Intent i2 = new Intent(Mock3.this,End2.class);
    startActivity(i2);
   finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
...
int[] numbers = {71,135,84,30,11,181,221,236,251,230,303,296,472,324,432,687,581,624,683,778,765,767,707,784};
...
else
{
  ...
  mdb.updateMock3(0);
      ...
      score=0;
       mdb.close();
  Intent i3 = new Intent(Mock3.this,End2.class);
  startActivity(i3);
 finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
