...
public class Mock6 extends Activity
{
        ...
        case END:
         ...
         builder.setMessage("Are you sure you want to exit?")
               ...
               .setPositiveButton("Yes", new DialogInterface.OnClickListener() 
               {
                   ...
                   mdb.open();
                   mdb.updateMock6(score);
                   mdb.close();
                   Intent i1 = new Intent(Mock6.this,End6.class);
           startActivity(i1);
...
break;
   default:
    mSoundManager.playSound(2);
    Intent i2 = new Intent(Mock6.this,End6.class);
    startActivity(i2);
   finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
...
int[] numbers = {62,14,79,86,77,240,173,219,202,208,337,273,340,395,397,553,682,605,621,793,704,747,744,764};
...
else
{
  ...
  */
  ...
  mdb.updateMock6(0);
      ...
      score=0;
       mdb.close();
  Intent i3 = new Intent(Mock6.this,End6.class);
  startActivity(i3);
 finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
