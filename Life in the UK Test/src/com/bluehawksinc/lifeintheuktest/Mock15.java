...
public class Mock15 extends Activity
{
        ...
        case END:
         ...
         builder.setMessage("Are you sure you want to exit?")
               ...
               .setPositiveButton("Yes", new DialogInterface.OnClickListener() 
               {
                   ...
                   mdb.open();
                   mdb.updateMock15(score);
                   mdb.close();
                   Intent i1 = new Intent(Mock15.this,End15.class);
           startActivity(i1);
...
break;
   default:
    mSoundManager.playSound(2);
    Intent i2 = new Intent(Mock15.this,End15.class);
    startActivity(i2);
   finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
...
int[] numbers = {130,61,90,37,227,188,166,204,247,317,435,351,443,283,578,579,518,580,686,758,730,760,819,801};
...
else
{
  ...
  mdb.updateMock15(0);
      ...
      score=0;
       mdb.close();
  Intent i3 = new Intent(Mock15.this,End15.class);
  startActivity(i3);
 finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
