...
public class Mock7 extends Activity
{
        ...
        case END:
         ...
         builder.setMessage("Are you sure you want to exit?")
               ...
               .setPositiveButton("Yes", new DialogInterface.OnClickListener() 
               {
                   ...
                   mdb.open();
                   mdb.updateMock7(score);
                   mdb.close();
                   Intent i1 = new Intent(Mock7.this,End7.class);
           startActivity(i1);
...
break;
   default:
    mSoundManager.playSound(2);
    Intent i2 = new Intent(Mock7.this,End7.class);
    startActivity(i2);
   finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
...
int[] numbers = {68,103,123,93,38,157,150,244,257,293,330,441,429,282,589,561,495,676,486,719,715,743,802,705};
...
else
{
  ...
  mdb.updateMock7(0);
      ...
      score=0;
       mdb.close();
  Intent i3 = new Intent(Mock7.this,End7.class);
  startActivity(i3);
 finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
