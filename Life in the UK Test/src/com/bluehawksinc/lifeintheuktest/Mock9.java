...
public class Mock9 extends Activity
{
        ...
        case END:
         ...
         builder.setMessage("Are you sure you want to exit?")
               ...
               .setPositiveButton("Yes", new DialogInterface.OnClickListener() 
               {
                   ...
                   mdb.open();
                   mdb.updateMock9(score);
                   mdb.close();
                   Intent i1 = new Intent(Mock9.this,End9.class);
           startActivity(i1);
           finish();
...
break;
   default:
    mSoundManager.playSound(2);
    Intent i2 = new Intent(Mock9.this,End9.class);
    startActivity(i2);
    finish();
    if (mInterstitial.isLoaded()) {
        mInterstitial.show();
...
int[] numbers = {19,48,65,80,171,199,152,245,197,442,479,477,457,288,606,659,548,643,512,701,753,708,800,795};
...
else
{
  ...
  Intent i3 = new Intent(Mock9.this,End9.class);
  startActivity(i3);
  finish();
	if (mInterstitial.isLoaded()) {
        mInterstitial.show();
