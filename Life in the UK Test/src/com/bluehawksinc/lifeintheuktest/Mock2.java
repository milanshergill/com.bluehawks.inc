...
public class Mock2 extends Activity
{
        ...
        case END:
         ...
         builder.setMessage("Are you sure you want to exit?")
               ...
               .setPositiveButton("Yes", new DialogInterface.OnClickListener() 
               {
                   ...
                   mdb.open();
                   mdb.updateMock2(score);
                   mdb.close();
                   Intent i1 = new Intent(Mock2.this,End1.class);
           startActivity(i1);
...
break;
   default:
    mSoundManager.playSound(2);
    Intent i2 = new Intent(Mock2.this,End1.class);
    startActivity(i2);
   finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
...
int[] numbers = {107,21,129,35,46,215,172,207,260,357,338,355,471,392,634,584,602,523,691,710,729,714,703,735};
...
else
{
  ...
  mdb.updateMock2(0);
      ...
      score=0;
       mdb.close();
  Intent i3 = new Intent(Mock2.this,End1.class);
  startActivity(i3);
 finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
