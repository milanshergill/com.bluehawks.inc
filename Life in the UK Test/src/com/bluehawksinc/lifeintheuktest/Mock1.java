...
public class Mock1 extends Activity {
	...
	public long timestart = 30000;
	public long timeend = 1000;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			...
			incorrect = (ArrayList<Integer>) savedInstanceState
					.getIntegerArrayList("MyArray");
			timestart = savedInstanceState.getLong("MyTime");
					...
					.setPositiveButton("Yes",
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
									...
									mdb.open();
									mdb.updateMock1(score);
									mdb.close();

									Intent i1 = new Intent(Mock1.this,
											End.class);
									startActivity(i1);
	...
	private View.OnClickListener Listener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			default:
				mSoundManager.playSound(2);
				Intent i2 = new Intent(Mock1.this, End.class);
				startActivity(i2);
				finish();
	...
	/*
	 * ArrayList<Integer> numbers = new ArrayList<Integer>(); { for(int i = 1; i
	 * <= 5; i++) { numbers.add(i); } Collections.shuffle(numbers);
	 * 
	 * }
	 */
	int[] numbers = { 33, 6, 12, 89, 58, 201, 211, 178, 191, 241, 374, 449,
			298, 391, 306, 534, 611, 654, 662, 508, 712, 724, 821, 790 };
	...
	void displayQuestion() {
		if (count < (numbers.length - 1)) {
			...
			Intent i3 = new Intent(Mock1.this, End.class);
			startActivity(i3);
			finish();
			 if (mInterstitial.isLoaded()) {
			        mInterstitial.show();
	...
	public void onSaveInstanceState(Bundle savedInstanceState) {
		...
		savedInstanceState.putLong("MyTime", timestart - 1000);
		// etc.
