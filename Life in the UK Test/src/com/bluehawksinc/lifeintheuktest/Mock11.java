...
public class Mock11 extends Activity
{
        ...
        case END:
         ...
         builder.setMessage("Are you sure you want to exit?")
               ...
               .setPositiveButton("Yes", new DialogInterface.OnClickListener() 
               {
                   ...
                   mdb.open();
                   mdb.updateMock11(score);
                   mdb.close();
                   Intent i1 = new Intent(Mock11.this,End11.class);
           startActivity(i1);
...
break;
   default:
    mSoundManager.playSound(2);
    Intent i2 = new Intent(Mock11.this,End11.class);
    startActivity(i2);
   finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
...
int[] numbers = {78,5,34,73,192,187,162,218,209,268,394,270,428,423,515,531,636,667,575,749,803,770,786,700};
...
else
{
  ...
  mdb.updateMock11(0);
      ...
      score=0;
       mdb.close();
  Intent i3 = new Intent(Mock11.this,End11.class);
  startActivity(i3);
 finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
