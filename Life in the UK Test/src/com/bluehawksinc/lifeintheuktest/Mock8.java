...
public class Mock8 extends Activity
{
        ...
        case END:
         ...
         builder.setMessage("Are you sure you want to exit?")
               ...
               .setPositiveButton("Yes", new DialogInterface.OnClickListener() 
               {
                   ...
                   mdb.open();
                   mdb.updateMock8(score);
                   mdb.close();
                   Intent i1 = new Intent(Mock8.this,End8.class);
           startActivity(i1);
...
break;
   default:
    mSoundManager.playSound(2);
    Intent i2 = new Intent(Mock8.this,End8.class);
    startActivity(i2);
   finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
...
int[] numbers = {106,81,17,132,118,137,239,194,195,258,342,377,420,412,501,538,529,552,557,798,773,745,711,804};
...
else
{
  ...
  mdb.updateMock8(0);
      ...
      score=0;
       mdb.close();
  Intent i3 = new Intent(Mock8.this,End8.class);
  startActivity(i3);
 finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
