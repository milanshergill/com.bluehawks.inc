...
public class Mock10 extends Activity
{
        ...
        case END:
         ...
         builder.setMessage("Are you sure you want to exit?")
               ...
               .setPositiveButton("Yes", new DialogInterface.OnClickListener() 
               {
                   ...
                   mdb.open();
                   mdb.updateMock10(score);
                   mdb.close();
                   Intent i1 = new Intent(Mock10.this,End10.class);
           startActivity(i1);
...
break;
   default:
    mSoundManager.playSound(2);
    Intent i2 = new Intent(Mock10.this,End10.class);
    startActivity(i2);
   finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
...
int[] numbers = {92,117,43,108,138,210,259,176,198,356,362,426,422,480,670,649,542,685,788,777,816,750,807,224};
...
else
{
  ...
  mdb.updateMock10(0);
      ...
      score=0;
       mdb.close();
  Intent i3 = new Intent(Mock10.this,End10.class);
  startActivity(i3);
 finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
