...
public class Mock4 extends Activity
{
...
private SoundManager mSoundManager;
  ...
  Sound_Button.setImageResource(R.drawable.mute);
     ...
     Setting.Sound = true;
       ...
       // radioGroup.Animation(hyperspaceJumpAnimation6);
        ...
        case END:
         ...
         builder.setMessage("Are you sure you want to exit?")
               ...
               .setPositiveButton("Yes", new DialogInterface.OnClickListener() 
               {
                   ...
                   mdb.open();
                   mdb.updateMock4(score);
                   mdb.close();
                   Intent i1 = new Intent(Mock4.this,End3.class);
           startActivity(i1);
...
break;
   default:
    mSoundManager.playSound(2);
    Intent i2 = new Intent(Mock4.this,End3.class);
    startActivity(i2);
   finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
...
int [] numbers = {112,67,22,26,116,235,205,144,164,170,467,382,307,427,651,524,525,488,497,789,813,817,809,737};
...
else
{
  ...
  mdb.updateMock4(0);
      ...
      score=0;
       mdb.close();
  Intent i3 = new Intent(Mock4.this,End3.class);
  startActivity(i3);
 finish();if (mInterstitial.isLoaded()) mInterstitial.show();
