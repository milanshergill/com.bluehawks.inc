...
public class Mock14 extends Activity
{
        ...
        case END:
         ...
         builder.setMessage("Are you sure you want to exit?")
               ...
               .setPositiveButton("Yes", new DialogInterface.OnClickListener() 
               {
                   ...
                   mdb.open();
                   mdb.updateMock14(score);
                   mdb.close();
                   Intent i1 = new Intent(Mock14.this,End14.class);
           startActivity(i1);
...
break;
   default:
    mSoundManager.playSound(2);
    Intent i2 = new Intent(Mock14.this,End14.class);
    startActivity(i2);
   finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
...
int[] numbers = {121,55,41,27,165,184,223,174,179,380,421,445,470,464,607,653,672,592,601,779,731,717,775,806};
...
else
{
  ...
  mdb.updateMock14(0);
      ...
      score=0;
       mdb.close();
  Intent i3 = new Intent(Mock14.this,End14.class);
  startActivity(i3);
 finish();if (mInterstitial.isLoaded()) mInterstitial.show();
}
}
