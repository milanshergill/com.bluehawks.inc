...
public class End7 extends Activity 
{
       ...
       Sound_Button.setOnClickListener(new View.OnClickListener() 
       {
        ...
        findViewById(R.id.home).setOnClickListener(new View.OnClickListener() 
        {
    		public void onClick(View v) 
    		{
    			...
    			Intent i1 = new Intent(End7.this,Main_Screen.class);
    			startActivity(i1);
    			finish();
    		}
    	});
        ...
        next1.setOnClickListener(new View.OnClickListener() 
        {
			...
			public void onClick(View v)
			{
				mSoundManager.playSound(2);
				//mSoundManager.playSound(1);
				Intent i1 = new Intent(End7.this,Mock.class);
				startActivity(i1);
				finish();
			}
		});
        findViewById(R.id.answer).setOnClickListener(new View.OnClickListener() 
        {
    		public void onClick(View v) 
    		{
    			if(Mock7.incorrect.isEmpty())
    			{
    				AlertDialog.Builder builder = new AlertDialog.Builder(End7.this);
    			...
    			{
    			//mSoundManager.playSound(1);
    			Intent i1 = new Intent(End7.this,ans7.class);
    			startActivity(i1);
    			finish();
    			}
    		}
